...
--log-wandb --wandb-kwargs project=melo_iclr_adam_vs_adamw_rn20 name="\"rn20_adam_iter${iter}_lr${lr}_wd${wd}_seed${seed}\"" --seed $seed
"""
...
def main():
    ...
    base_dir = os.getcwd()
    lrs = [0.1 * 2**i for i in range(-10, 1)]
