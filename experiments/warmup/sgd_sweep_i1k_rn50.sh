...
do
    ...
    do
        ...
        --log-wandb --wandb-kwargs project=melo_warmup name="\"i1k-rn50-nzi-b256x128-bn-momentum-lr$lr-s$seed\"" --seed $seed
    done
done
...
do
    ...
    do
        ...
        --log-wandb --wandb-kwargs project=melo_warmup name="\"i1k-rn50-nzi-b256x8-bn-momentum-lr$lr-s$seed\"" --seed $seed
    done
done
...
do
    ...
    do
        ...
        --log-wandb --wandb-kwargs project=melo_warmup name="\"i1k-rn50-nzi-b256x32-bn-momentum-lr$lr-s$seed\"" --seed $seed
    done
done
